...
p2.addEventListener('click', () => paintACE('ace/theme/' + (p2 === "(prefers-color-scheme: light)" ? 'crimson_editor' : 'tomorrow_night_bright')));

var p1 = document.querySelector('input[id="__palette_1"]')
p1.addEventListener('click', () => paintACE('ace/theme/' + (p1 === "(prefers-color-scheme: dark)" ? 'tomorrow_night_bright' : 'crimson_editor')));
